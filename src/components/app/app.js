...
import FavoriteList from "../favorit-list/favorit-list";
import MoviesGallery from "../movies-gallery/movies-gallery";
...
export default class App extends Component {
            ...
            moviesDb: [
                {
                    ...
                    like: false,
                    img:
                        "https://images-na.ssl-images-amazon.com/images/I/5147KKVUmkL._SX342_.jpg",
                    description:
                ...
                },
                {
                    ...
                    like: false,
                    img:
                        "https://is4-ssl.mzstatic.com/image/thumb/Video49/v4/c7/eb/a2/c7eba221-510f-c3bf-2775-71c388110c1b/pr_source.lsr/268x0w.png",
                    description:
                ...
                },
                {
                    ...
                    like: false,
                    img:
                        "https://vinyla.com/files/products/various-artists-quentin-tarantinos-once-upon-a-time-in-hollywood.1280x1280.jpg?4c6eb144294b125cd575a94eb91afcd0",
                    description:
    ...
    onToggleLiked (id) {
        this.setState(({moviesDb}) => {
            const index = moviesDb.findIndex(elem => elem.id === id);

            const old = moviesDb[index];
            const newItem = {...old, like: !old.like};

            const newArr = [...moviesDb.slice(0, index), newItem, ...moviesDb.slice(index + 1)];
    ...
    render() {
        return (
            <div className="app">
                <MoviesGallery
                    movies={this.state.moviesDb}
                    onToggleLiked={this.onToggleLiked}
                />
                <FavoriteList movies={this.state.moviesDb} />
            </div>
        );
    };
};
